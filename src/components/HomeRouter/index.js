...
import {FcGenericSortingAsc, FcGenericSortingDesc} from 'react-icons/fs'
        ...
        return (
            ...
            <div className="card-container-row">
              ...
              <div className="card-list" testid="countryWideActiveCases">
                ...
                />
                <p className="card-paragraph-heading blue">{totalActive}</p>
              </div>
            ...
            <div className="card-list" testid="countryWideDeceasedCases">
                ...
                <img 
                  src=""
                  alt="country wide decrease cases pic"
                  className="home-cards-logo"
                />
    ...
    render() {
        ...
        return (
            <div className="covid-home-container">
                {isLoading ? (
                    <div className="loading-class" testid="homeRouterLoader">
